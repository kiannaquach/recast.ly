    ...
    return (
      <div className="video-list-entry media">
        ...
        <div className="media-body">  
          <div className="video-list-entry-title" onClick={this.handleClicks.bind(this, this.props.videos)}>{this.props.videos.snippet.title}</div>
